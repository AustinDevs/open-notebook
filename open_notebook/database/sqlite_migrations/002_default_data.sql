...
-- Insert default transformations, episode profiles, and speaker profiles

-- ============================================================================
-- DEFAULT TRANSFORMATIONS
-- ============================================================================

INSERT OR IGNORE INTO transformation (name, title, description, prompt, apply_default) VALUES
('Analyze Paper', 'Paper Analysis', 'Analyses a technical/scientific paper', '# IDENTITY and PURPOSE
...
- Output only the requested sections with their respective labels.', 0),

('Key Insights', 'Key Insights', 'Extracts important insights and actionable items', '# IDENTITY and PURPOSE
...
- Ensure you follow ALL these instructions when creating your output.', 0),

('Dense Summary', 'Dense Summary', 'Creates a rich, deep summary of the content', '# MISSION
...
# METHODOLOGY
Render the input as a distilled list of succinct statements, assertions, associations, concepts, analogies, and metaphors. The idea is to capture as much, conceptually, as possible but with as few words as possible. Write it in a way that makes sense to you, as the future audience will be another language model, not a human. Use complete sentences.', 1),

('Reflections', 'Reflection Questions', 'Generates reflection questions from the document to help explore it further', '# IDENTITY and PURPOSE
...
- Do not give warnings or notes; only output the requested section.', 0),

('Table of Contents', 'Table of Contents', 'Describes the different topics of the document', '# SYSTEM ROLE
...
- Gives a small description of what is covered', 0),

('Simple Summary', 'Simple Summary', 'Generates a small summary of the content', '# SYSTEM ROLE
...
- Maintains context from any previous summaries', 0);

-- ============================================================================
-- DEFAULT EPISODE PROFILES
-- ============================================================================

INSERT OR IGNORE INTO episode_profile (name, description, speaker_config, outline_provider, outline_model, transcript_provider, transcript_model, default_briefing, num_segments) VALUES
('tech_discussion', 'Technical discussion between 2 experts', 'tech_experts', 'openai', 'gpt-4o-mini', 'openai', 'gpt-4o-mini', 'Create an engaging technical discussion about the provided content. Focus on practical insights, real-world applications, and detailed explanations that would interest developers and technical professionals.', 5),

('solo_expert', 'Single expert explaining complex topics', 'solo_expert', 'openai', 'gpt-4o-mini', 'openai', 'gpt-4o-mini', 'Create an educational explanation of the provided content. Break down complex concepts into digestible segments, use analogies and examples, and maintain an engaging teaching style.', 4),

('business_analysis', 'Business-focused analysis and discussion', 'business_panel', 'openai', 'gpt-4o-mini', 'openai', 'gpt-4o-mini', 'Analyze the provided content from a business perspective. Discuss market implications, strategic insights, competitive advantages, and actionable business intelligence.', 6);

-- ============================================================================
-- DEFAULT SPEAKER PROFILES
-- ============================================================================

INSERT OR IGNORE INTO speaker_profile (name, description, tts_provider, tts_model, speakers) VALUES
('tech_experts', 'Two technical experts for tech discussions', 'openai', 'gpt-4o-mini-tts', '[{"name": "Dr. Alex Chen", "voice_id": "nova", "backstory": "Senior AI researcher and former tech lead at major companies. Specializes in making complex technical concepts accessible.", "personality": "Analytical, clear communicator, asks probing questions to dig deeper into technical details"}, {"name": "Jamie Rodriguez", "voice_id": "alloy", "backstory": "Full-stack engineer and tech entrepreneur. Loves practical applications and real-world implementations.", "personality": "Enthusiastic, practical-minded, great at explaining implementation details and trade-offs"}]'),

('solo_expert', 'Single expert for educational content', 'openai', 'gpt-4o-mini-tts', '[{"name": "Professor Sarah Kim", "voice_id": "nova", "backstory": "Distinguished professor and researcher. Has a gift for making complex topics accessible to broad audiences.", "personality": "Patient teacher, uses analogies and examples, breaks down complex concepts step by step"}]'),

('business_panel', 'Business analysis panel with diverse perspectives', 'openai', 'gpt-4o-mini-tts', '[{"name": "Marcus Thompson", "voice_id": "echo", "backstory": "Former McKinsey consultant, now startup advisor. Expert in strategic analysis and market dynamics.", "personality": "Strategic thinker, data-driven, excellent at identifying key insights and implications"}, {"name": "Elena Vasquez", "voice_id": "shimmer", "backstory": "Serial entrepreneur and investor. Focuses on practical implementation and execution.", "personality": "Action-oriented, pragmatic, brings startup experience and execution focus"}, {"name": "Johny Bing", "voice_id": "ash", "backstory": "Youtube celebrity and business mogul. Focuses on practical implementation and execution.", "personality": "Controversial, likes to question ideas and concepts. He brings a fresh perspective and always has a point to make."}]');
