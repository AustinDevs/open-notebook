...
class S3Config(RecordModel):
    """
    Singleton configuration for S3 storage credentials.
    ...
    record_id: ClassVar[str] = "open_notebook:s3_config"
    ...
    async def update(self) -> "S3Config":
        """
    ...
    @classmethod
    async def get_instance(cls) -> "S3Config":
        """
    ...
    @classmethod
    def get_sync(cls) -> Optional["S3Config"]:
        """
    ...
    async def clear_credentials(self) -> None:
        ...
        # Reset the S3 client cache
        from open_notebook.utils.storage import _reset_s3_client
