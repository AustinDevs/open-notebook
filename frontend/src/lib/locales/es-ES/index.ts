export const esES = {
  ...
  creation: {
    listDesc: "Genera y gestiona creaciones de IA a partir de tus cuadernos.",
    generate: "Generar",
    generateTitle: "Generar {name}",
    ...
    rendererUnavailable: "No hay visualización disponible para este tipo de creación",
    viewRawData: "Ver datos sin procesar",
    invalidArtifactData: "No se pudieron mostrar los datos de esta creación.",
    status: {
      submitted: "En cola",
      running: "Generando",
      completed: "Completado",
    ...
    mindmap: {
      ...
      exportPng: "Exportar PNG",
      exportSvg: "Exportar SVG",
      renderError: "Error al renderizar el mapa mental",
    },
  },
  podcasts: {
