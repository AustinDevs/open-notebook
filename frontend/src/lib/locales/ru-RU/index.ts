export const ruRU = {
  ...
  settings: {
    ...
    docHelp: "· Авто (рекомендуется) использует модели зрения для PDF и Office документов, обеспечивая отличное извлечение текста, таблиц и изображений. · Простой извлекает базовый текст из документов без расширенного форматирования.",
    firecrawl: "Firecrawl",
    jina: "Jina",
