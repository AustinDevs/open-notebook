export const itIT = {
  ...
  settings: {
    ...
    docHelp: "· Auto (consigliato) utilizza modelli di visione per PDF e documenti Office, fornendo un'eccellente estrazione di testo, tabelle e immagini. · Semplice estrarrà il contenuto testuale base dai documenti senza formattazione avanzata.",
    firecrawl: "Firecrawl",
    jina: "Jina",
