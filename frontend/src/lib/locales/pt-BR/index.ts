export const ptBR = {
  ...
  settings: {
    ...
    docHelp: "· Auto (recomendado) usa modelos de visão para PDFs e documentos Office, proporcionando excelente extração de texto, tabelas e imagens. · Simples extrairá o conteúdo básico de texto dos documentos sem formatação avançada.",
    firecrawl: "Firecrawl",
    jina: "Jina",
  ...
  apiKeys: {
    ...
    vertexConfigNote: "O Google Vertex AI requer um projeto GCP e conta de serviço. Configure via variáveis de ambiente para melhor segurança.",
    ...
    defaultModelHint: "O modelo a ser usado por padrão (ex.: gpt-4, gpt-3.5-turbo)",
