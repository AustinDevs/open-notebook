export const ptBR = {
  ...
  creation: {
    listDesc: "Gere e gerencie criações de IA a partir dos seus cadernos.",
    generate: "Gerar",
    generateTitle: "Gerar {name}",
    generating: "Gerando...",
    ...
    rendererUnavailable: "Nenhuma visualização disponível para este tipo de criação",
    viewRawData: "Ver dados brutos",
    invalidArtifactData: "Não foi possível exibir os dados desta criação.",
    status: {
      submitted: "Na fila",
      running: "Gerando",
      completed: "Concluído",
    ...
    mindmap: {
      ...
      exportPng: "Exportar PNG",
      exportSvg: "Exportar SVG",
      renderError: "Falha ao renderizar o mapa mental",
    },
  },
  podcasts: {
