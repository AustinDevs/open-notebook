export const zhCN = {
  ...
  settings: {
    ...
    simple: "Simple",
    helpMeChoose: "帮助我选择",
    docHelp: "· 自动 (推荐): 使用视觉模型处理 PDF 和 Office 文档，可以出色地提取文本、表格和图像。 · Simple: 从文档中提取基本文本内容，不进行高级格式化。",
    firecrawl: "Firecrawl",
    jina: "Jina",
  ...
  apiKeys: {
    ...
    vertexConfigNote: "Google Vertex AI 需要 GCP 项目和服务账户。建议通过环境变量配置以获得更好的安全性。",
    ...
    baseUrlHint: "默认：{url}",
    defaultModel: "默认模型",
    defaultModelHint: "默认使用的模型（例如：gpt-4、gpt-3.5-turbo）",
    noConfigs: "暂无配置",
