export const enUS = {
  ...
  settings: {
    ...
    docHelp: "· Auto (recommended) will use vision models for PDFs and Office documents, providing excellent extraction of text, tables, and images. · Simple will extract basic text content from documents without advanced formatting.",
    firecrawl: "Firecrawl",
    jina: "Jina",
  ...
  apiKeys: {
    ...
    vertexConfigNote: "Google Vertex AI requires a GCP project and service account. Configure via environment variables for best security.",
    ...
    defaultModelHint: "The model to use by default (e.g., gpt-4, gpt-3.5-turbo)",
