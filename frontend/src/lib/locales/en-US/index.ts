export const enUS = {
  ...
  creation: {
    listDesc: "Generate and manage AI creations from your notebooks.",
    generate: "Generate",
    generateTitle: "Generate {name}",
    ...
    rendererUnavailable: "No renderer available for this creation type",
    viewRawData: "View raw data",
    invalidArtifactData: "This creation's data could not be displayed.",
    status: {
      submitted: "Queued",
      running: "Generating",
      completed: "Completed",
